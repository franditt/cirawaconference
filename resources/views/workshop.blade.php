    ...
    <body class="antialiased">
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 selection:bg-red-500 selection:text-white">
            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                ...
                <!-- CIRAWA Conference 2026 Workshop Submission Form -->
                <div class="container">
                    <div class="card">
                        ...
                        <form action="{{ route('workshop.submit') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row two">
                                <div>
        ...
        <script>
            (function(){
                ...
                const form = document.querySelector('form[action="{{ route('workshop.submit') }}"]');
